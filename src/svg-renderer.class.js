...
export class SvgRendererClass {
    ...
    constructor() {
        ...
        const containerInnerHeight = this.svgCanvas.node().getBoundingClientRect().height - 2*SvgRendererClass.containerPadding;
    ...
    render() {
        ...
        this.renderContainer = this.svg
            .append('g')
            .attr('transform', `translate(${SvgRendererClass.containerPadding}, ${SvgRendererClass.containerPadding})`);

        this.mapGroup = this.renderContainer
            .append('g')
            .classed('map-group', true);

        this.timeGroup = this.renderContainer
            .append('g')
            .attr('transform', `translate(0, ${SvgRendererClass.mapHeight + SvgRendererClass.timePaddingTop})`)
    ...
    static getSvgHeight() {
        ...
        return SvgRendererClass.mapHeight + SvgRendererClass.timeHeight + overallHeightPadding + SvgRendererClass.timePaddingTop;
    }
}